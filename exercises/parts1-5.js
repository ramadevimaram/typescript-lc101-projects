...
console.log(spaceShuttle.name + " would take " + spaceShuttle.printDaysToLocation(new SpaceLocation_1.SpaceLocation('Mars', kilometersToMars)) + "days to get to Mars");
console.log(spaceShuttle.name + " would take " + spaceShuttle.printDaysToLocation(new SpaceLocation_1.SpaceLocation('the Moon', kilometersToTheMoon)) + " days to get to Moon");
