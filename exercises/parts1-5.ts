...
// instance of the class.
   // console.log(`${spaceShuttle.name}   would take ${spaceShuttle.getDaysToLocation(kilometersToMars)}days to get to Mars`);
    ...
    console.log(`${spaceShuttle.name} would take ${spaceShuttle.printDaysToLocation(new SpaceLocation('Mars', kilometersToMars))}days to get to Mars`);
    console.log(`${spaceShuttle.name} would take ${spaceShuttle.printDaysToLocation(new SpaceLocation('the Moon', kilometersToTheMoon))} days to get to Moon`);
